...
* [x] Create a new branch: git checkout -b sandy-jernigan.
* [x] Implement the project on your newly created sandy-jernigan branch, committing changes regularly.
* [x] Push commits: git push origin sandy-jernigan.
